...
-- Admins
(1, 'Dupont', 'Jean', 'jean.dupont@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(1, 'Bernard', 'Sophie', 'sophie.bernard@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(1, 'Morel', 'Antoine', 'antoine.morel@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(1, 'Garcia', 'Elise', 'elise.garcia@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),

-- Formateurs
(3, 'Martin', 'Lucie', 'lucie.martin@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Lemoine', 'Pierre', 'pierre.lemoine@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Blanc', 'Isabelle', 'isabelle.blanc@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Fischer', 'Hugo', 'hugo.fischer@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Girard', 'Camille', 'camille.girard@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Robin', 'Maxime', 'maxime.robin@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Noel', 'Juliette', 'juliette.noel@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Rey', 'Thomas', 'thomas.rey@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Perrot', 'Chloe', 'chloe.perrot@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Baron', 'Louis', 'louis.baron@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(3, 'Moulin', 'Emma', 'emma.moulin@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),

-- Stagiaires et candidats (répartition aléatoire)
(2, 'Leroy', 'Nathan', 'nathan.leroy@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'David', 'Alice', 'alice.david@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Moreau', 'Hugo', 'hugo.moreau@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Simon', 'Jade', 'jade.simon@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Roux', 'Leo', 'leo.roux@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Vincent', 'Manon', 'manon.vincent@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Bertrand', 'Ethan', 'ethan.bertrand@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Lambert', 'Clara', 'clara.lambert@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Henry', 'Gabriel', 'gabriel.henry@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Masson', 'Lina', 'lina.masson@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Garnier', 'Alexis', 'alexis.garnier@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Chevalier', 'Sofia', 'sofia.chevalier@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Lucas', 'Matteo', 'matteo.lucas@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Bonnet', 'Louise', 'louise.bonnet@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'François', 'Evan', 'evan.francois@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Dupuis', 'Elena', 'elena.dupuis@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Berger', 'Oscar', 'oscar.berger@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Gautier', 'Mila', 'mila.gautier@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Roger', 'Arthur', 'arthur.roger@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Collet', 'Léa', 'lea.collet@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Guillot', 'Theo', 'theo.guillot@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Barre', 'Emma', 'emma.barre@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Perrin', 'Lucas', 'lucas.perrin@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Renard', 'Elise', 'elise.renard@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Marchal', 'Adam', 'adam.marchal@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Leclerc', 'Camille', 'camille.leclerc@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Bouvier', 'Noah', 'noah.bouvier@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Giraud', 'Nina', 'nina.giraud@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Leger', 'Enzo', 'enzo.leger@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Besson', 'Sarah', 'sarah.besson@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Durand', 'Mael', 'mael.durand@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Fleury', 'Zoé', 'zoe.fleury@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Benoit', 'Raphael', 'raphael.benoit@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Poulain', 'Lola', 'lola.poulain@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Germain', 'Eliott', 'eliott.germain@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Barbier', 'Ava', 'ava.barbier@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Chauvin', 'Timéo', 'timeo.chauvin@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Pichon', 'Salomé', 'salome.pichon@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Legrand', 'Mathis', 'mathis.legrand@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Roy', 'Iris', 'iris.roy@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Picard', 'Valentin', 'valentin.picard@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Mallet', 'Lou', 'lou.mallet@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Devaux', 'Paul', 'paul.devaux@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Maillard', 'Sacha', 'sacha.maillard@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Charpentier', 'Eden', 'eden.charpentier@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Hoarau', 'Elsa', 'elsa.hoarau@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Gosselin', 'Jules', 'jules.gosselin@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Descamps', 'Ambre', 'ambre.descamps@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(2, 'Chapel', 'Esteban', 'esteban.chapel@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG'),
(4, 'Legendre', 'Luna', 'luna.legendre@example.com', '$2y$10$.PM1iz26ZgKIBLA5yWRrGuasHQHk3asBTNHxwxVxpcvF4QbZVbWUG');
